...
`File Source` 是基于 [Source API]({{< ref "docs/connectors/sources" >}}#the-data-source-api) 同时支持批模式和流模式文件读取的统一 Source。
...
[documentation on data sources]({{< ref "docs/connectors/sources" >}}) 和在
