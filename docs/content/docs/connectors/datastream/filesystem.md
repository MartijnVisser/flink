...
The `File Source` is based on the [Source API]({{< ref "docs/connectors/sources" >}}#the-data-source-api), 
...
[documentation on data sources]({{< ref "docs/connectors/sources" >}}) and
