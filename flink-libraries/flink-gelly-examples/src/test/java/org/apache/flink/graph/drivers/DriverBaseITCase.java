...
public abstract class DriverBaseITCase extends MultipleProgramsTestBase {
    ...
    /**
     * Simpler variant of {@link #expectedOutput(String[], String)} that converts the {@link
     * Checksum} to a string and ignores leading and trailing newlines.
     *
     ...
     */
    protected void expectedChecksum(String[] parameters, long expectedCount, long expectedChecksum)
            throws Exception {
    ...
    /**
     * Simpler variant of {@link #expectedOutput(String[], String)} that only compares the count of
     * the number of records in standard output. This is intended for use for algorithms where the
     * result cannot be hashed due to approximate results (typically floating point arithmetic).
     *
     * @param parameters algorithm, input, and output arguments
    ...
    /**
     * Executes the driver with the provided arguments and compares the standard output with the
    ...
    /**
     * Simpler variant of {@link #expectedOutput(String[], String)} that sums the hashCode() of each
     * line of output.
     *
     * @param parameters algorithm, input, and output arguments
    ...
    /**
     * Executes the driver with the provided arguments and compares the exception and exception
     * method with the given class and regular expression.
     *
     * @param parameters algorithm, input, and output arguments
     * @param expected expected standard output
    ...
    /**
     * Generate a regular expression string by quoting the input string and adding wildcard matchers
    ...
    /**
     * Implements a Hamcrest regex matcher. Hamcrest 2.0 provides Matchers.matchesPattern(String)
     * but Flink depends on Hamcrest 1.3.
     *
