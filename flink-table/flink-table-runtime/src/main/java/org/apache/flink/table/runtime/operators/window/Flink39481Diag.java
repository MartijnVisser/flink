 ...
 *
 * <p>Other modules (e.g. flink-runtime) that cannot depend on this class log to the same logger
 * name {@code org.apache.flink.FLINK39481} directly, so a single log4j line enables everything.
 */
public final class Flink39481Diag {

    /** Dedicated, greppable logger. Enable at DEBUG in the relevant log4j2 configuration. */
